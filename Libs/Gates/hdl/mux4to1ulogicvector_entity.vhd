-- VHDL Entity gates.mux4to1ULogicVector.symbol
--
-- Created:
...
ENTITY mux4to1ULogicVector IS
   ...
   PORT( 
      ...
      in2    : IN     std_ulogic_vector (dataBitNb-1 DOWNTO 0);
      in3    : IN     std_ulogic_vector (dataBitNb-1 DOWNTO 0);
